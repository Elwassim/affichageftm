...
export const PermanencesPolitiquesWidget = () => {
  ...
  useEffect(() => {
    const loadPermanences = async () => {
      try {
        ...
        console.log("🔍 All permanences data:", permanencesData);
        console.log(
          "🔍 Types found:",
        ...
        console.log("🏛️ Political permanences found:", permanencesPolitiques);
    ...
    <Card className="p-3 bg-white professional-shadow border-0 h-full flex flex-col">
      <div className="mb-3">
        <h2 className="text-lg font-black text-cgt-gray flex items-center gap-2">
          ...
          Permanences Politiques - 7 jours
        </h2>
      ...
      {permanences.length === 0 ? (
        <div className="text-center py-4">
          ...
          <p className="text-gray-500 text-xs">
            Aucune permanence politique ces 7 prochains jours
          </p>
        </div>
      ) : (
        <div
